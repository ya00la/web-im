...
module.exports = React.createClass({
    ...
    getStrangers: function () {
        ...
        for (var o in Demo.strangers) {
            if (Demo.strangers.hasOwnProperty(o)) {
                var nick = Demo.strangers[o][0].msg.ext.nick;
                var header = Demo.strangers[o][0].msg.ext.header;
                strangers.push({name: o, header: header, nick: nick});
            }
        }
                ...
                case 'groups':
                    ...
                    for (var i = 0; i < this.state.groups.length; i++) {
                        if (id == this.state.groups[i].roomId) {
                            ...
                            props.openStrangeChat = this.openStrangeChat;
