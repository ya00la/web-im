...
module.exports = React.createClass({
    ...
    render: function () {
        ...
        var showEmoji = this.state.showEmoji ? '' : ' hide',
            ...
            fixRight = (Demo.selectedCate == 'chatrooms' || Demo.selectedCate == 'groups') ? '': ' button-right';
        var roomMember = [];
        var keyValue = 0;
        ...
        return (
            <div className='webim-send-wrapper'>
                ...
                <textarea maxLength="500" ref='textarea' onKeyDown={this.handleKeyDown}
                          style={{width: (Demo.selectedCate == 'chatrooms' || Demo.selectedCate == 'groups') ? '': '100%'}}></textarea>
                <Button className={'webim-send-btn base-bgcolor' + disabled + fixRight} text={Demo.lan.send}
