...
module.exports = React.createClass({
    ...
    getInitialState: function () {
        ...
        return {
            src: 'http://images.kaishiba.com/crowd-header.png'
        };
    },
    ...
    render: function () {
        ...
        for (var i = 0; i < this.props.groups.length; i++) {
            g.push(<Item id={this.props.groups[i].roomId} cate='groups' key={this.props.groups[i].roomId} username={this.props.groups[i].name}
                         update={this.update} cur={this.props.curNode} src={this.props.groups[i].header || this.state.src} brief={this.getBrief(this.props.groups[i].roomId)}/>);
        }
        ...
        for (var i = 0; i < this.props.strangers.length; i++) {
            s.push(<Item id={this.props.strangers[i].name} cate='strangers' key={this.props.strangers[i].name}
                         ...
                         src={this.props.strangers[i].header} nick={this.props.strangers[i].nick}
